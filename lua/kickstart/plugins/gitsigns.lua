...
||||||| parent of 431cf2e (Fix formating of plugins)
        map('n', '[c', function()
          if vim.wo.diff then
            vim.cmd.normal { '[c', bang = true }
          else
...
<<<<<<< HEAD
>>>>>>> 431cf2e (Fix formating of plugins)
||||||| parent of 8137a41 (update with some neovim go debugging and a git blame shortcut)
=======
||||||| parent of 532d80d (update with some neovim go debugging and a git blame shortcut)
        -- Actions
        -- visual mode
...
>>>>>>> 532d80d (update with some neovim go debugging and a git blame shortcut)
